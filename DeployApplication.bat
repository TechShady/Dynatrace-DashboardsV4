...
echo | set /p=.
powershell -Command "Get-ChildItem -Path ./Transform\*.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern 'InternalCompareAppID') {(Get-Content $_ | ForEach {$_ -replace 'InternalCompareAppID', '!internalextractedname!'}) | Set-Content $_ -encoding UTF8}}"
REM Replace all tenant names
if %posnum% NEQ 1 (powershell -Command "Get-ChildItem -Path ./Transform\*.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern 'fbe8d3b1-ccb9-480c-9e5d-0e1b8b4da313') {(Get-Content $_ | ForEach {$_ -replace 'fbe8d3b1-ccb9-480c-9e5d-0e1b8b4da313', 'fbe8d3b1-ccb9-480c-9e5d-0e1b8b4da%overviewkey%'}) | Set-Content $_ -encoding UTF8}}")
...
if !appname! EQU NOAPP (powershell -Command "Get-ChildItem -Path ./Transform\*.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern ' where useraction.application=') {(Get-Content $_ | ForEach {$_ -replace ' where useraction.application=', ' where useraction.application<>'}) | Set-Content $_ -encoding UTF8}}")
echo | set /p=.
...
echo | set /p=.
curl -X PUT "https://!tenant!/api/config/v1/dashboards/fbe8d3b1-ccb9-480c-9e5d-0e1b8b3da%dashboardkey%" -H "accept: application/json; charset=utf-8" -H "Authorization: Api-Token %1" -H "Content-Type: application/json; charset=utf-8" -d @./Transform\AppOverview.json
echo | set /p=.
...
powershell -Command "Get-ChildItem -Path ./Transform/KeyStore.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern '##  ') {(Get-Content $_ | ForEach {$_ -replace '##  ', '## %dashboardkey% !appname! Application Added to %overviewkey% at Position %posnum%\n##  '}) | Set-Content $_ -encoding UTF8}}"
...
REM Get Tenant Overview Dashboard
...
if %posnum% EQU 2 (powershell -Command "Get-ChildItem -Path ./Transform\TempOverview.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern '2 Logs') {(Get-Content $_ | ForEach {$_ -replace '2 Logs', '%appname% Overview'}) | Set-Content $_ -encoding UTF8}}"
powershell -Command "Get-ChildItem -Path ./Transform\TempOverview.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern 'logmonitoring') {(Get-Content $_ | ForEach {$_ -replace 'logmonitoring', 'dashboard;id=fbe8d3b1-ccb9-480c-9e5d-0e1b8b3da%dashboardkey%'}) | Set-Content $_ -encoding UTF8}}")
if %posnum% EQU 3 (powershell -Command "Get-ChildItem -Path ./Transform\TempOverview.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern '3 Smartscape') {(Get-Content $_ | ForEach {$_ -replace '3 Smartscape', '%appname% Overview'}) | Set-Content $_ -encoding UTF8}}"
powershell -Command "Get-ChildItem -Path ./Transform\TempOverview.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern 'smartscape') {(Get-Content $_ | ForEach {$_ -replace 'smartscape', 'dashboard;id=fbe8d3b1-ccb9-480c-9e5d-0e1b8b3da%dashboardkey%'}) | Set-Content $_ -encoding UTF8}}")
if %posnum% EQU 4 (powershell -Command "Get-ChildItem -Path ./Transform\TempOverview.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern '4 Diagnostics') {(Get-Content $_ | ForEach {$_ -replace '4 Diagnostics', '%appname% Overview'}) | Set-Content $_ -encoding UTF8}}"
powershell -Command "Get-ChildItem -Path ./Transform\TempOverview.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern 'diagnostictools') {(Get-Content $_ | ForEach {$_ -replace 'diagnostictools', 'dashboard;id=fbe8d3b1-ccb9-480c-9e5d-0e1b8b3da%dashboardkey%'}) | Set-Content $_ -encoding UTF8}}")
if %posnum% EQU 5 (powershell -Command "Get-ChildItem -Path ./Transform\TempOverview.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern '5 Services') {(Get-Content $_ | ForEach {$_ -replace '5 Services', '%appname% Overview'}) | Set-Content $_ -encoding UTF8}}"
powershell -Command "Get-ChildItem -Path ./Transform\TempOverview.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern 'newservices') {(Get-Content $_ | ForEach {$_ -replace 'newservices', 'dashboard;id=fbe8d3b1-ccb9-480c-9e5d-0e1b8b3da%dashboardkey%'}) | Set-Content $_ -encoding UTF8}}")
if %posnum% EQU 6 (powershell -Command "Get-ChildItem -Path ./Transform\TempOverview.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern '6 Databases') {(Get-Content $_ | ForEach {$_ -replace '6 Databases', '%appname% Overview'}) | Set-Content $_ -encoding UTF8}}"
powershell -Command "Get-ChildItem -Path ./Transform\TempOverview.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern 'newdatabases') {(Get-Content $_ | ForEach {$_ -replace 'newdatabases', 'dashboard;id=fbe8d3b1-ccb9-480c-9e5d-0e1b8b3da%dashboardkey%'}) | Set-Content $_ -encoding UTF8}}")
if %posnum% EQU 7 (powershell -Command "Get-ChildItem -Path ./Transform\TempOverview.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern '7 Hosts') {(Get-Content $_ | ForEach {$_ -replace '7 Hosts', '%appname% Overview'}) | Set-Content $_ -encoding UTF8}}"
powershell -Command "Get-ChildItem -Path ./Transform\TempOverview.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern 'newhosts') {(Get-Content $_ | ForEach {$_ -replace 'newhosts', 'dashboard;id=fbe8d3b1-ccb9-480c-9e5d-0e1b8b3da%dashboardkey%'}) | Set-Content $_ -encoding UTF8}}")
if %posnum% EQU 8 (powershell -Command "Get-ChildItem -Path ./Transform\TempOverview.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern '8 Technologies') {(Get-Content $_ | ForEach {$_ -replace '8 Technologies', '%appname% Overview'}) | Set-Content $_ -encoding UTF8}}"
powershell -Command "Get-ChildItem -Path ./Transform\TempOverview.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern 'newprocessessummary') {(Get-Content $_ | ForEach {$_ -replace 'newprocessessummary', 'dashboard;id=fbe8d3b1-ccb9-480c-9e5d-0e1b8b3da%dashboardkey%'}) | Set-Content $_ -encoding UTF8}}")
if %posnum% EQU 9 (powershell -Command "Get-ChildItem -Path ./Transform\TempOverview.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern '9 Deploy') {(Get-Content $_ | ForEach {$_ -replace '9 Deploy', '%appname% Overview'}) | Set-Content $_ -encoding UTF8}}"
powershell -Command "Get-ChildItem -Path ./Transform\TempOverview.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern 'deploy') {(Get-Content $_ | ForEach {$_ -replace 'deploy', 'dashboard;id=fbe8d3b1-ccb9-480c-9e5d-0e1b8b3da%dashboardkey%'}) | Set-Content $_ -encoding UTF8}}")
if %posnum% EQU 10 (powershell -Command "Get-ChildItem -Path ./Transform\TempOverview.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern '10 Applications') {(Get-Content $_ | ForEach {$_ -replace '10 Applications', '%appname% Overview'}) | Set-Content $_ -encoding UTF8}}"
powershell -Command "Get-ChildItem -Path ./Transform\TempOverview.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern 'uemapplications') {(Get-Content $_ | ForEach {$_ -replace 'uemapplications', 'dashboard;id=fbe8d3b1-ccb9-480c-9e5d-0e1b8b3da%dashboardkey%'}) | Set-Content $_ -encoding UTF8}}")
if %posnum% EQU 11 (powershell -Command "Get-ChildItem -Path ./Transform\TempOverview.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern '11 Sessions') {(Get-Content $_ | ForEach {$_ -replace '11 Sessions', '%appname% Overview'}) | Set-Content $_ -encoding UTF8}}"
powershell -Command "Get-ChildItem -Path ./Transform\TempOverview.json -recurse | ForEach {If (Get-Content $_.FullName | Select-String -Pattern 'usersearchoverview') {(Get-Content $_ | ForEach {$_ -replace 'usersearchoverview', 'dashboard;id=fbe8d3b1-ccb9-480c-9e5d-0e1b8b3da%dashboardkey%'}) | Set-Content $_ -encoding UTF8}}")
